const questions = [
  ...
  "Что такое план тестирования(какие разделы включает)? Тестовая стратегия?",
  ...
  "У вас есть 2000 тестов и 1 день на регрессию какие тесты будете проводить?",
  ...
  "Примеры бага с выским Severity и низким Priority?",
  "Примеры бага с выским Priority и низким Severity?",
  "Затвра выход в продакшн а вы обнаружили критический баг твои действия?",
  ...
  "Что такое эстимация?Какие виды эстимации вы знаете?",
  "Что такое клиент-серверная архитектура?Какие виды?",
  "Что такое HTTP?Из чего состоит запрос?Из чего состоит ответ?",
  "Список кодов состояния HTTP?",
  "Что такое HTTPS?",
  "HTTP методы?Идемпотентность HTTP-методов?Какие методы могут кешироваться а какие нет?Какие методы считаются безопасными а какие нет?",
  "Cashe и cookie?Виды куков?Где хранится cashe и cookies?",
  "Что такое Web-Service?Что такое WSDL?",
  "Что такое API?Виды API?Full REST API?",
  ...
  "Что такое логи?Для чего нужны и какие виды существуют?Уровни логирования?",
  "Снифферы трафика?",
  "Agile model?Canban vs Scrum?",
