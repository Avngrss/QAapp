const questions = [
  ...
  "Что такое БД? СУБД?Реляционная база данных? Виды БД по моделям данных?",
  ...
  `Что такое Непрерывная интеграция (Continuous Integration, CI) преимущество? ?Непрерывная доставка (Continuous Delivery, CD) преимущество?`,
];
